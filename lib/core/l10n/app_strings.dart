class AppStrings {
  ...
  String get newJobAlerts => _t({
    ...
    'bn': 'নতুন চাকরির সতর্কতা',
    'ru': 'Уведомления о новых вакансиях',
    'id': 'Notifikasi lowongan baru',
    'ne': 'नयाँ जागिर सूचना',
    'km': 'ការជូនដំណឹងការងារថ្មី',
    'my': 'အလုပ်သစ် အသိပေးချက်',
    'si': 'නව රැකියා දැනුම්දීම්',
    'uz': 'Yangi ish bildirishnomalari',
  ...
  String get searchGuide => _t({
    ...
    'ru':
        'Ищите вакансии, компании и др. (название компании на корейском/английском)',
    'id':
        'Cari pekerjaan, perusahaan, dll (nama perusahaan dalam Korea/Inggris)',
    ...
    'my':
        'အလုပ်အကိုင်၊ ကုမ္ပဏီ စသည် ရှာဖွေပါ (ကုမ္ပဏီအမည်ကို ကိုရီးယား/အင်္ဂလိပ်)',
    'si': 'රැකියා, සමාගම් ආදිය සොයන්න (සමාගම් නම කොරියානු/ඉංග්‍රීසියෙන්)',
    'uz':
        'Kasb, kompaniya va h.k. qidiring (kompaniya nomi koreys/ingliz tilida)',
  ...
  String get visaGroupAny => _t({
    ...
    'uz': 'Vizani tekshiring',
    'mn': 'Виз шалгах',
  }, 'Check Visa');

  String get visaGroupE => _t({
    'ko': 'E — 취업/전문',
    'en': 'E — Employment/Professional',
    'zh': 'E — 就业/专业',
    'hi': 'E — रोजगार/पेशेवर',
    'ja': 'E — 就業/専門',
    'th': 'E — จ้างงาน/วิชาชีพ',
    'vi': 'E — Việc làm/Chuyên gia',
    'bn': 'E — কর্মসংস্থান/পেশাদার',
    'ru': 'E — Трудоустройство',
    'id': 'E — Pekerjaan/Profesional',
    'ne': 'E — रोजगार/पेशेवर',
    'km': 'E — ការងារ/វិជ្ជាជីវៈ',
    'my': 'E — အလုပ်/ပညာရှင်',
    'si': 'E — රැකියා/වෘත්තීය',
    'uz': 'E — Ish/Mutaxassis',
    'mn': 'E — Хөдөлмөр/Мэргэжил',
  }, 'E — Employment/Professional');

  String get visaGroupH => _t({
    'ko': 'H — 워킹홀리데이/방문취업',
    'en': 'H — Working Holiday/Visit',
    'zh': 'H — 打工度假/访问就业',
    'hi': 'H — वर्किंग हॉलिडे/विज़िट',
    'ja': 'H — ワーキングホリデー/訪問就業',
    'th': 'H — วันหยุดทำงาน/เยี่ยมชม',
    'vi': 'H — Working Holiday/Thăm',
    'bn': 'H — ওয়ার্কিং হলিডে/ভিজিট',
    'ru': 'H — Рабочие каникулы',
    'id': 'H — Working Holiday/Kunjungan',
    'ne': 'H — वर्किंग हलिडे/भ्रमण',
    'km': 'H — ថ្ងៃឈប់សម្រាកការងារ/ទស្សនកិច្ច',
    'my': 'H — အလုပ်အားလပ်ရက်/လည်ပတ်',
    'si': 'H — වැඩ නිවාඩු/සංචාරය',
    'uz': 'H — Ishchi ta\'til/Tashrif',
    'mn': 'H — Ажлын амралт/Айлчлал',
  }, 'H — Working Holiday/Visit');

  String get visaGroupF => _t({
    'ko': 'F — 재외동포/거주',
    'en': 'F — Overseas Korean/Residence',
    'zh': 'F — 海外同胞/居住',
    'hi': 'F — विदेशी कोरियाई/निवास',
    'ja': 'F — 在外同胞/居住',
    'th': 'F — ชาวเกาหลีโพ้นทะเล/ถิ่นที่อยู่',
    'vi': 'F — Kiều bào Hàn/Cư trú',
    'bn': 'F — প্রবাসী কোরিয়ান/বসবাস',
    'ru': 'F — Зарубежные корейцы/Проживание',
    'id': 'F — Korea perantauan/Tinggal',
    'ne': 'F — विदेशी कोरियन/बसोबास',
    'km': 'F — កូរ៉េក្រៅប្រទេស/លំនៅដ្ឋាន',
    'my': 'F — နိုင်ငံခြားကိုရီးယား/နေထိုင်',
    'si': 'F — විදේශ කොරියානු/පදිංචිය',
    'uz': 'F — Yashash/Chet eldagi koreys',
    'mn': 'F — Оршин суух/Гадаад солонгос',
  }, 'F — Overseas Korean/Residence');

  String get visaGroupD => _t({
    'ko': 'D — 유학/연수/투자',
    'en': 'D — Study/Training/Investment',
    'zh': 'D — 留学/研修/投资',
    'hi': 'D — अध्ययन/प्रशिक्षण/निवेश',
    'ja': 'D — 留学/研修/投資',
    'th': 'D — เรียน/ฝึกงาน/ลงทุน',
    'vi': 'D — Du học/Thực tập/Đầu tư',
    'bn': 'D — পড়াশোনা/প্রশিক্ষণ/বিনিয়োগ',
    'ru': 'D — Учёба/Стажировка/Инвестиции',
    'id': 'D — Studi/Pelatihan/Investasi',
    'ne': 'D — अध्ययन/तालिम/लगानी',
    'km': 'D — សិក្សា/បណ្ដុះបណ្ដាល/វិនិយោគ',
    'my': 'D — ပညာ/လေ့ကျင့်/ရင်းနှီးမြှုပ်နှံ',
    'si': 'D — අධ්‍යයනය/පුහුණුව/ආයෝජනය',
    'uz': 'D — O\'qish/Amaliyot/Investitsiya',
    'mn': 'D — Суралцах/Дадлага/Хөрөнгө оруулалт',
  ...
  // 월급 범위
  List<String> get salaryMonthlyOptions => [
    salaryAll,
    salaryUnder100,
    salary100to200,
    salary200to300,
  ...
  List<String> get salaryHourlyOptions => [
    salaryAll,
    hourly10000to12000,
    hourly12000to15000,
    hourlyOver15000,
  ...
  List<String> get salaryAnnualOptions => [
    salaryAll,
    annualUnder2000,
    annual2000to3000,
    annual3000to4000,
  ...
  }, 'Apply in person by visiting the company');
  String get applyMethodOtherDesc => _t({
    'ko': '우편 등 그 외 방법으로 지원해요',
    'en': 'Apply using other methods such as mail',
  }, 'Apply using other methods such as mail');

  // 정규화 코드 → 한줄 설명. 미지 코드/전화(번호를 대신 보여줌)는 null.
  String? applyMethodDesc(String code) {
    switch (code) {
      case 'online':
        return applyMethodOnlineDesc;
      case 'homepage':
      ...
      case 'simple':
        return applyMethodSimpleDesc;
      case 'chat':
        return applyMethodChatDesc;
      case 'visit':
        return applyMethodVisitDesc;
      case 'other':
        return applyMethodOtherDesc;
      default:
        return null;
    }
  }
  ...
  String? applyMethodLabel(String code) {
    switch (code) {
      case 'online':
        return applyMethodOnline;
      case 'homepage':
        return applyMethodHomepage;
      case 'email':
        return applyMethodEmail;
      case 'phone':
        return applyMethodPhone;
      case 'sms':
        return applyMethodSms;
      case 'simple':
        return applyMethodSimple;
      case 'chat':
        return applyMethodChat;
      case 'visit':
        return applyMethodVisit;
      case 'other':
        return applyMethodOther;
      default:
        return null;
    }
  }
  ...
  String translateJobCategory(String nameEn) => switch (nameEn) {
    'IT & Development' => _t({
      ...
      'th': 'ไอที & พัฒนา',
      'uz': 'IT & Dasturlash',
      'km': 'ព័ត៌មានវិទ្យា និងអភិវឌ្ឍន៍',
      'my': 'IT နှင့် ဖွံ့ဖြိုးရေး',
      'mn': 'IT & Хөгжүүлэлт',
      'ja': 'IT・開発',
      'si': 'IT සහ සංවර්ධන',
      'bn': 'আইটি ও উন্নয়ন',
    ...
    'Agriculture, Forestry & Fishing' => _t({
      ...
      'th': 'เกษตร ป่าไม้ และประมง',
      'uz': 'Qishloq, o\'rmon va baliqchilik',
      'km': 'កសិកម្ម វនសាស្ត្រ និងនេសាទ',
      'ne': 'कृषि, वन र मत्स्य',
      'id': 'Pertanian, Kehutanan & Perikanan',
      'my': 'စိုက်ပျိုးရေး သစ်တောနှင့် ငါးဖမ်း',
      'mn': 'Хөдөө аж ахуй, ойн аж ахуй, загасчлал',
      'ja': '農林水産',
      'si': 'කෘෂිකර්ම, වනවිද්‍යා සහ ධීවර',
      'bn': 'কৃষি, বনায়ন ও মৎস্য',
    ...
    'Logistics' => _t({
      ...
      'en': 'Logistics',
      'zh': '物流·搬运',
      'vi': 'Vận chuyển & Kho vận',
      'th': 'โลจิสติกส์',
      'uz': 'Logistika',
      'km': 'ដឹកជញ្ជូន',
      'my': 'ထောက်ပံ့ပို့ဆောင်ရေး',
      'mn': 'Логистик',
      'ja': '物流・運搬',
      'si': 'සැපයුම් දාම',
      'bn': 'লজিস্টিক',
    ...
    'Office & Admin' => _t({
      ...
      'en': 'Office & Admin',
      'zh': '办公·行政',
      'vi': 'Văn phòng & Hành chính',
      'th': 'สำนักงาน & ธุรการ',
      'uz': 'Ofis va ma\'muriyat',
      'km': 'ការិយាល័យ និងរដ្ឋបាល',
      'my': 'ရုံးနှင့် စီမံရေး',
      'mn': 'Оффис & Удирдлага',
      'ja': '事務・管理',
      'si': 'කාර්යාලය සහ පරිපාලන',
      'bn': 'অফিস ও প্রশাসন',
      'ru': 'Офис и администрирование',
      'hi': 'कार्यालय और प्रशासन',
      'ne': 'कार्यालय तथा प्रशासन',
    ...
    'Service & Sales' => _t({
      ...
      'th': 'บริการ & การขาย',
      'uz': 'Xizmat va savdo',
      'km': 'សេវាកម្ម និងការលក់',
      'my': 'ဝန်ဆောင်မှုနှင့် အရောင်း',
      'mn': 'Үйлчилгээ & Борлуулалт',
      'ja': 'サービス・販売',
      'si': 'සේවා සහ විකුණුම්',
      'bn': 'সেবা ও বিক্রয়',
      'ru': 'Сервис и продажи',
    ...
    'Food & Cooking' => _t({
      ...
      'vi': 'Ẩm thực & Nấu ăn',
      'th': 'อาหาร & ทำอาหาร',
      'uz': 'Ovqat va pazandachilik',
      'km': 'អាហារ និងការចម្អិន',
      'my': 'စားသောက်နှင့် ချက်ပြုတ်',
      'mn': 'Хоол & Тогооч',
      'ja': '飲食・調理',
      'si': 'ආහාර සහ පිසීම',
      'bn': 'খাদ্য ও রান্না',
    ...
    'Cleaning & Facility' => _t({
      'ko': '청소·시설',
      'en': 'Cleaning & Facility',
      'zh': '清洁·设施',
      'vi': 'Vệ sinh & Cơ sở vật chất',
      'th': 'ทำความสะอาด & สิ่งอำนวยความสะดวก',
      'uz': 'Tozalash va binolar',
      'km': 'សម្អាត និងគ្រប់គ្រងអគារ',
      'my': 'သန့်ရှင်းရေးနှင့် အဆောက်အအုံ',
      'mn': 'Цэвэрлэгээ & Байгууламж',
      'ja': '清掃・施設',
      'si': 'පිරිසිදු කිරීම සහ පහසුකම්',
      'bn': 'পরিচ্ছন্নতা ও সুবিধা',
      'ru': 'Уборка и обслуживание',
      'hi': 'सफ़ाई और सुविधा',
      'ne': 'सरसफाइ तथा सुविधा',
      'id': 'Kebersihan & Fasilitas',
    }, 'Cleaning & Facility'),
    'Marketing & Sales' => _t({
      'ko': '마케팅·영업',
      'en': 'Marketing & Sales',
      'zh': '营销·销售',
      'vi': 'Marketing & Kinh doanh',
      'th': 'การตลาด & การขาย',
      'uz': 'Marketing va savdo',
      'km': 'ទីផ្សារ និងការលក់',
      'ne': 'मार्केटिङ र बिक्री',
      'id': 'Pemasaran & Penjualan',
      'my': 'စျေးကွက်နှင့် အရောင်း',
      'mn': 'Маркетинг & Борлуулалт',
      'ja': 'マーケティング・営業',
      'si': 'අලෙවිකරණය සහ විකුණුම්',
      'bn': 'মার্কেটিং ও বিক্রয়',
    ...
    'Media, Culture & Sports' => _t({
      ...
      'zh': '媒体·文化·体育',
      'vi': 'Truyền thông, Văn hóa & Thể thao',
      'th': 'สื่อ วัฒนธรรม & กีฬา',
      'uz': 'Media, madaniyat va sport',
      'km': 'ប្រព័ន្ធផ្សព្វផ្សាយ វប្បធម៌ និងកីឡា',
      'ne': 'मिडिया, संस्कृति र खेलकुद',
      'id': 'Media, Budaya & Olahraga',
      'my': 'မီဒီယာ ယဉ်ကျေးမှုနှင့် အားကစား',
      'mn': 'Медиа, соёл & спорт',
      'ja': 'メディア・文化・スポーツ',
      'si': 'මාධ්‍ය, සංස්කෘතික සහ ක්‍රීඩා',
      'bn': 'মিডিয়া, সংস্কৃতি ও খেলাধুলা',
      'ru': 'Медиа, культура и спорт',
    ...
    'Translation·Interpretation' => _t({
      ...
      'zh': '翻译·口译',
      'vi': 'Dịch thuật & Phiên dịch',
      'th': 'การแปล & ล่าม',
      'uz': 'Tarjima va tarjimonlik',
      'km': 'បកប្រែ និងអ្នកបកប្រែ',
      'ne': 'अनुवाद र दोभाषे',
      'id': 'Penerjemahan & Interpretasi',
      'my': 'ဘာသာပြန်နှင့် စကားပြန်',
      'mn': 'Орчуулга & Хэлмэрч',
      'ja': '翻訳・通訳',
      'si': 'පරිවර්තන සහ භාෂණ',
      'bn': 'অনুবাদ ও দোভাষী',
    ...
    'Transportation & Driving' => _t({
      'ko': '운수·운전',
      'en': 'Transportation & Driving',
      'zh': '运输·驾驶',
      'vi': 'Vận tải & Lái xe',
      'th': 'ขนส่ง & ขับรถ',
      'uz': 'Transport va haydovchilik',
      'km': 'ដឹកជញ្ជូន និងបើកបរ',
      'ne': 'यातायात र ड्राइभिङ',
      'id': 'Transportasi & Mengemudi',
      'my': 'သယ်ယူပို့ဆောင်ရေးနှင့် ယာဉ်မောင်း',
      'mn': 'Тээвэр & Жолоодлого',
      'ja': '運輸・運転',
      'si': 'ප්‍රවාහනය සහ රිය පැදවීම',
      'bn': 'পরিবহন ও ড্রাইভিং',
  ...
  String? translateJobTypeRaw(String jobTypeKo) => switch (jobTypeKo) {
    ...
    '생산·공정 관리자' => _t({
      ...
      'vi': 'Quản lý sản xuất',
      'th': 'ผู้จัดการการผลิต',
      'uz': 'Ishlab chiqarish boshqaruvchisi',
      'km': 'អ្នកគ្រប់គ្រងផលិតកម្ម',
      'ne': 'उत्पादन प्रबन्धक',
      'id': 'Manajer Produksi',
      'my': 'ထုတ်လုပ်ရေးမန်နေဂျာ',
      'mn': 'Үйлдвэрлэлийн менежер',
      'ja': '生産・工程管理者',
      'si': 'නිෂ්පාදන කළමනාකරු',
      'bn': 'উৎপাদন ব্যবস্থাপক',
      'ru': 'Менеджер производства',
      'hi': 'उत्पादन प्रबंधक',
    }, 'Production Manager'),
    '의료상담·코디네이터' => _t({
      'ko': '의료상담·코디네이터',
      'en': 'Medical Coordinator',
      'zh': '医疗咨询·协调员',
      'vi': 'Điều phối viên y tế',
      'th': 'ผู้ประสานงานแพทย์',
      'uz': 'Tibbiy koordinator',
      'km': 'អ្នកសម្របសម្រួលវេជ្ជសាស្ត្រ',
      'ne': 'चिकित्सा समन्वयक',
      'id': 'Koordinator Medis',
      'my': 'ဆေးဘက်ညှိနှိုင်းရေးမှူး',
      'mn': 'Эмнэлгийн зохицуулагч',
      'ja': '医療相談・コーディネーター',
      'si': 'වෛද්‍ය සම්බන්ධීකාරක',
      'bn': 'চিকিৎসা সমন্বয়কারী',
      'ru': 'Медицинский координатор',
      'hi': 'चिकित्सा समन्वयक',
    }, 'Medical Coordinator'),
    '의료통번역' => _t({
      'ko': '의료통번역',
      'en': 'Medical Interpreter',
      'zh': '医疗翻译',
      'vi': 'Phiên dịch y tế',
      'th': 'ล่ามแพทย์',
      'uz': 'Tibbiy tarjimon',
      'km': 'អ្នកបកប្រែវេជ្ជសាស្ត្រ',
      'ne': 'चिकित्सा अनुवादक',
      'id': 'Penerjemah Medis',
      'my': 'ဆေးဘက်စကားပြန်',
      'mn': 'Эмнэлгийн орчуулагч',
      'ja': '医療通訳・翻訳',
      'si': 'වෛද්‍ය පරිවර්තක',
      'bn': 'চিকিৎসা দোভাষী',
      'ru': 'Медицинский переводчик',
    ...
    '피부관리사' => _t({
      ...
      'zh': '皮肤管理师',
      'vi': 'Chuyên viên chăm sóc da',
      'th': 'ผู้เชี่ยวชาญดูแลผิว',
      'uz': 'Teri parvarish mutaxassisi',
      'km': 'អ្នកថែរក្សាស្បែក',
      'ne': 'छाला विशेषज्ञ',
      'id': 'Spesialis Perawatan Kulit',
      'my': 'အသားအရေထိန်းသိမ်းမှုပညာရှင်',
      'mn': 'Арьс арчилгааны мэргэжилтэн',
      'ja': 'スキンケア専門家',
      'si': 'සම සත්කාර විශේෂඥ',
      'bn': 'ত্বকযত্ন বিশেষজ্ঞ',
      'ru': 'Специалист по уходу за кожей',
      'hi': 'त्वचा विशेषज्ञ',
    }, 'Skincare Specialist'),
    '상품 기획' => _t({
      'ko': '상품 기획',
      'en': 'Product Planning',
      'zh': '产品策划',
      'vi': 'Hoạch định sản phẩm',
      'th': 'วางแผนผลิตภัณฑ์',
      'uz': 'Mahsulot rejalashtirish',
      'km': 'ផែនការផលិតផល',
      'ne': 'उत्पाद योजना',
      'id': 'Perencanaan Produk',
      'my': 'ကုန်ပစ္စည်းစီစဉ်ရေး',
      'mn': 'Бүтээгдэхүүн төлөвлөлт',
      'ja': '商品企画',
      'si': 'නිෂ්පාදන සැලසුම්',
      'bn': 'পণ্য পরিকল্পনা',
      'ru': 'Планирование продукции',
      'hi': 'उत्पाद योजना',
    }, 'Product Planning'),
    '물류·구매 관리자' => _t({
      'ko': '물류·구매 관리자',
      'en': 'Logistics & Purchasing Manager',
      'zh': '物流·采购经理',
      'vi': 'Quản lý hậu cần & mua hàng',
      'th': 'ผู้จัดการโลจิสติกส์และจัดซื้อ',
      'uz': 'Logistika va xarid boshqaruvchisi',
      'km': 'អ្នកគ្រប់គ្រងដឹកជញ្ជូន និងទិញទំនិញ',
      'ne': 'रसद र खरिद प्रबन्धक',
      'id': 'Manajer Logistik & Pembelian',
      'my': 'ထောက်ပံ့ပို့ဆောင်ရေးနှင့်ဝယ်ယူရေးမန်နေဂျာ',
      'mn': 'Логистик & Худалдан авалтын менежер',
      'ja': '物流・購買管理者',
      'si': 'සැපයුම් සහ මිලදී ගැනීම් කළමනාකරු',
      'bn': 'সরবরাহ ও ক্রয় ব্যবস্থাপক',
      'ru': 'Менеджер по логистике и закупкам',
    ...
    '정보통신기술(ICT), 연구개발' || 'IT기술지원' => _t({
      ...
      'vi': 'Hỗ trợ CNTT',
      'th': 'สนับสนุน IT',
      'uz': 'IT qo\'llab-quvvatlash',
      'km': 'គាំទ្រព័ត៌មានវិទ្យា',
      'ne': 'IT सहायता',
      'id': 'Dukungan IT',
      'my': 'IT ပံ့ပိုးမှု',
      'mn': 'IT дэмжлэг',
    ...
    '채널 관리자·크리에이티브 디렉터' => _t({
      'ko': '채널 관리자·크리에이티브 디렉터',
      'en': 'Creative Director',
      'zh': '创意总监',
      'vi': 'Giám đốc sáng tạo',
      'th': 'ผู้อำนวยการครีเอทีฟ',
      'uz': 'Kreativ direktor',
      'km': 'នាយកច្នៃប្រឌិត',
      'ne': 'सिर्जनात्मक निर्देशक',
      'id': 'Direktur Kreatif',
      'my': 'ဖန်တီးမှုဒါရိုက်တာ',
      'mn': 'Бүтээлч захирал',
      'ja': 'クリエイティブディレクター',
      'si': 'නිර්මාණ අධ්‍යක්ෂ',
    ...
    '시설·설비 관리자' => _t({
      ...
      'th': 'ผู้จัดการอาคาร',
      'uz': 'Obyekt boshqaruvchisi',
      'km': 'អ្នកគ្រប់គ្រងអគារ',
      'ne': 'सुविधा प्रबन्धक',
      'id': 'Manajer Fasilitas',
      'my': 'အဆောက်အအုံမန်နေဂျာ',
      'mn': 'Байгууламжийн менежер',
      'ja': '施設管理者',
      'si': 'පහසුකම් කළමනාකරු',
      'bn': 'সুবিধা ব্যবস্থাপক',
      'ru': 'Менеджер по объектам',
      'hi': 'सुविधा प्रबंधक',
    }, 'Facility Manager'),
    '공장관리·안전관리·소방설비' => _t({
      'ko': '공장관리·안전관리',
      'en': 'Factory & Safety Manager',
      'zh': '工厂·安全管理',
      'vi': 'Quản lý nhà máy & an toàn',
      'th': 'ผู้จัดการโรงงานและความปลอดภัย',
      'uz': 'Zavod va xavfsizlik boshqaruvchisi',
      'km': 'អ្នកគ្រប់គ្រងរោងចក្រ និងសុវត្ថិភាព',
      'ne': 'कारखाना र सुरक्षा प्रबन्धक',
      'id': 'Manajer Pabrik & Keselamatan',
      'my': 'စက်ရုံနှင့်ဘေးကင်းရေးမန်နေဂျာ',
      'mn': 'Үйлдвэр & Аюулгүй байдлын менежер',
      'ja': '工場・安全管理者',
      'si': 'කර්මාන්තශාලා සහ ආරක්ෂක කළමනාකරු',
      'bn': 'কারখানা ও নিরাপত্তা ব্যবস্থাপক',
      'ru': 'Менеджер завода и безопасности',
    ...
    '운전·운송·배송' => _t({
      ...
      'vi': 'Lái xe & Giao hàng',
      'th': 'ขับรถ & จัดส่ง',
      'uz': 'Haydovchi va yetkazish',
      'km': 'បើកបរ និងដឹកជញ្ជូន',
      'ne': 'चालक र डेलिभरी',
      'id': 'Pengemudi & Pengiriman',
      'my': 'ယာဉ်မောင်းနှင့်ပို့ဆောင်',
      'mn': 'Жолооч & Хүргэлт',
      'ja': '運転・配送',
      'si': 'රියදුරු සහ බෙදාහැරීම',
      'bn': 'ড্রাইভার ও ডেলিভারি',
      'ru': 'Водитель и доставка',
    ...
    '기술연구/연구개발' || '연구개발' || '제품·공정, 연구개발' || '제품개발, 재료·화학' => _t({
      ...
      'th': 'วิจัยและพัฒนา',
      'uz': 'Tadqiqot va ishlanma',
      'km': 'ស្រាវជ្រាវ និងអភិវឌ្ឍន៍',
      'ne': 'अनुसन्धान र विकास',
      'id': 'Riset & Pengembangan',
      'my': 'သုတေသနနှင့်ဖွံ့ဖြိုးရေး',
      'mn': 'Судалгаа & Хөгжүүлэлт',
      'ja': '研究開発',
      'si': 'පර්යේෂණ සහ සංවර්ධන',
      'bn': 'গবেষণা ও উন্নয়ন',
      'ru': 'НИОКР',
    ...
    '재고관리' => _t({
      ...
      'uz': 'Ombor boshqaruvi',
      'km': 'គ្រប់គ្រងស្តុក',
      'ne': 'सामग्री व्यवस्थापन',
      'id': 'Manajemen Persediaan',
      'my': 'စတော့ထိန်းသိမ်းမှု',
      'mn': 'Нөөцийн менежмент',
      'ja': '在庫管理',
      'si': 'තොග කළමනාකරණය',
    ...
    '간병·사회복지사, 병동·외래보조' => _t({
      ...
      'th': 'การดูแลและสวัสดิการ',
      'uz': 'Parvarish va farovonlik',
      'km': 'ការថែទាំ និងសុខុមាលភាព',
      'ne': 'हेरचाह र कल्याण',
      'id': 'Perawatan & Kesejahteraan',
      'my': 'ပြုစုစောင့်ရှောက်ရေးနှင့်လူမှုဖူလုံရေး',
      'mn': 'Асаргаа & Халамж',
      'ja': '介護・福祉',
      'si': 'සත්කාර සහ සුබසාධන',
      'bn': 'পরিচর্যা ও কল্যাণ',
      'ru': 'Уход и соцзащита',
      'hi': 'देखभाल और कल्याण',
    }, 'Care & Welfare'),
    '기타 엔지니어' => _t({
  ...
  String translateBenefit(String nameEn) => switch (nameEn) {
    ...
    'Transportation Support' => _t({
      'ko': '교통비 지원',
      'en': 'Transportation Support',
      'zh': '交通补贴',
      'vi': 'Hỗ trợ đi lại',
      'th': 'สนับสนุนค่าเดินทาง',
      'uz': 'Transport xarajatlari',
      'km': 'ជំនួយដឹកជញ្ជូន',
      'my': 'သယ်ယူပို့ဆောင်ရေးထောက်ပံ့',
      'mn': 'Тээврийн зардал',
      'ja': '交通費支給',
      'si': 'ප්‍රවාහන දීමනා',
      'bn': 'পরিবহন ভাতা',
      'ru': 'Оплата проезда',
      'hi': 'परिवहन सहायता',
      'ne': 'यातायात खर्च सहयोग',
      'id': 'Tunjangan transportasi',
    ...
    'Housing Provided' => _t({
      ...
      'vi': 'Cung cấp chỗ ở',
      'th': 'มีที่พักให้',
      'uz': 'Turar joy taqdim etiladi',
      'km': 'ផ្តល់កន្លែងស្នាក់នៅ',
      'my': 'အိမ်ရာပံ့ပိုး',
      'mn': 'Байр олгоно',
      'ja': '住居提供',
      'si': 'නිවාස සපයනු ලැබේ',
      'bn': 'বাসস্থান প্রদান',
      'ru': 'Предоставляется жильё',
      'hi': 'आवास उपलब्ध',
      'ne': 'आवास उपलब्ध',
      'id': 'Disediakan tempat tinggal',
    }, 'Housing Provided'),
    'Meal Provided' => _t({
      'ko': '식사 제공',
      'en': 'Meal Provided',
      ...
      'vi': 'Cung cấp bữa ăn',
      'th': 'มีอาหารให้',
      'uz': 'Ovqat taqdim etiladi',
      'km': 'ផ្តល់អាហារ',
      'my': 'အစားအသောက်ပံ့ပိုး',
      'mn': 'Хоол олгоно',
      'ja': '食事提供',
      'si': 'ආහාර සපයනු ලැබේ',
      'bn': 'খাবার প্রদান',
      'ru': 'Предоставляется питание',
      'hi': 'भोजन उपलब्ध',
      'ne': 'खाना उपलब्ध',
      'id': 'Disediakan makan',
    }, 'Meal Provided'),
    'Severance Pay' => _t({
      ...
      'ru': 'Выходное пособие',
      'hi': 'विच्छेद वेतन',
      'ne': 'सेवानिवृत्ति भत्ता',
      'id': 'Pesangon',
    }, 'Severance Pay'),
    _ => nameEn,
  };

  // ── Account: 로그인/회원가입/마이페이지 (신규, ko/en만 — 나머지 언어는 en 폴백) ──
  String get accountLoginTitle =>
      _t({'ko': '로그인 · 회원가입', 'en': 'Log in · Sign up'}, 'Log in · Sign up');
  String get accountLoginSubtitle => _t({
    'ko': '지원 정보를 저장해두면\n다음부터 자동으로 채워드려요',
    'en': 'Save your info once and\nwe\'ll auto-fill it next time',
  }, 'Save your info once and we\'ll auto-fill it next time');
  String get accountContinueGoogle => _t({
    'ko': 'Google로 계속하기',
    'en': 'Continue with Google',
  }, 'Continue with Google');
  String get accountContinueApple => _t({
    'ko': 'Apple로 계속하기',
    'en': 'Continue with Apple',
  }, 'Continue with Apple');
  String get accountContinueFacebook => _t({
    'ko': 'Facebook으로 계속하기',
    'en': 'Continue with Facebook',
  }, 'Continue with Facebook');
  String get accountSkipLogin => _t({
    'ko': '로그인·회원가입 없이 계속하기',
    'en': 'Continue without login or signup',
  }, 'Continue without login or signup');
  String get accountSignupBigTitle => _t({
    'ko': '가입 완료까지 조금만 더 알려주세요',
    'en': 'Just a bit more to finish signing up',
  }, 'Just a bit more to finish signing up');
  String get accountAdditionalInfoTitle =>
      _t({'ko': '회원가입', 'en': 'Sign up'}, 'Sign up');
  String get accountFieldName => _t({
    'ko': '이름 (여권·신분증)',
    'en': 'Name (Passport/ID)',
  }, 'Name (Passport/ID)');
  ...
  }, 'Enter in English or Korean');
  String get accountFieldBirthDate => _t({
    'ko': '생년월일 (8자리)',
    'en': 'Date of birth (8 digits)',
  }, 'Date of birth (8 digits)');
  String get accountBirthDatePlaceholder =>
      _t({'ko': '예: 19950314', 'en': 'e.g. 19950314'}, 'e.g. 19950314');
  String get accountFieldGender => _t({'ko': '성별', 'en': 'Gender'}, 'Gender');
  String get accountGenderMale => _t({'ko': '남', 'en': 'Male'}, 'Male');
  String get accountGenderFemale => _t({'ko': '여', 'en': 'Female'}, 'Female');
  String get accountFieldNationality =>
      _t({'ko': '국적', 'en': 'Nationality'}, 'Nationality');
  String get accountFieldVisaType =>
      _t({'ko': '비자타입', 'en': 'Visa type'}, 'Visa type');
  String get accountSelectHint =>
      _t({'ko': '선택해주세요', 'en': 'Please select'}, 'Please select');
  String get accountFieldEmail => _t({'ko': '이메일', 'en': 'Email'}, 'Email');
  String get accountEmailInvalid => _t({
    'ko': '올바른 이메일 형식이 아니에요',
    'en': 'Please enter a valid email address',
  }, 'Please enter a valid email address');
  String get accountNameMixedScript => _t({
    'ko': '한글 또는 영어만 입력해주세요',
    'en': 'Please use only Korean or only English',
  }, 'Please use only Korean or only English');
  String get accountBirthDateInvalid => _t({
    'ko': '올바른 생년월일이 아니에요',
    'en': 'Please enter a valid date of birth',
  }, 'Please enter a valid date of birth');
  String get accountFieldPhone =>
      _t({'ko': '전화번호', 'en': 'Phone number'}, 'Phone number');
  String get accountPhoneMustStart010 => _t({
    'ko': '010으로 시작하는 번호를 입력해주세요',
    'en': 'Please enter a number starting with 010',
  }, 'Please enter a number starting with 010');
  String get accountConsentAll =>
      _t({'ko': '전체 동의', 'en': 'Agree to all'}, 'Agree to all');
  String get accountConsentTerms =>
      _t({'ko': '이용약관 동의', 'en': 'Terms of Service'}, 'Terms of Service');
  String get accountConsentPrivacy =>
      _t({'ko': '개인정보 수집·이용 동의', 'en': 'Privacy Policy'}, 'Privacy Policy');
  String get accountConsentThirdParty => _t({
    'ko': '개인정보 제3자 제공 동의',
    'en': 'Third-party data sharing',
  }, 'Third-party data sharing');
  String get accountConsentRequired =>
      _t({'ko': '필수', 'en': 'Required'}, 'Required');
  String get accountConsentView => _t({'ko': '보기', 'en': 'View'}, 'View');
  String get accountComplete => _t({'ko': '완료', 'en': 'Done'}, 'Done');
  String get accountEditProfileTitle =>
      _t({'ko': '개인정보 수정', 'en': 'Edit personal info'}, 'Edit personal info');
  String get accountSignupDoneToast => _t({
    'ko': '가입이 완료되었습니다',
    'en': 'Sign-up complete!',
  }, 'Sign-up complete!');
  String get accountProfileUpdatedToast => _t({
    'ko': '수정되었습니다',
    'en': 'Changes saved',
  }, 'Changes saved');
  ...
  String get accountNationalitySearchHint =>
      _t({'ko': '국가명 검색', 'en': 'Search country'}, 'Search country');
  String get accountNationalityPriority =>
      _t({'ko': '주요 국가', 'en': 'Major countries'}, 'Major countries');
  String get accountNationalityAll =>
      _t({'ko': '전체 국가', 'en': 'All countries'}, 'All countries');
  String get accountVisaHot =>
      _t({'ko': '자주 찾는 비자', 'en': 'Common visa types'}, 'Common visa types');
  String get accountVisaAll =>
      _t({'ko': '전체 비자', 'en': 'All visa types'}, 'All visa types');

  // ── 약관 상세 (초안, 정식 출시 전 법무 검토 필요) ──
  String get legalDraftNotice => _t({
    'ko': '※ 본 문서는 초안입니다. 정식 서비스 출시 전 법무 검토를 거쳐 확정됩니다.',
    'en':
        '※ This is a draft. It will be finalized after legal review before launch.',
  }, '※ This is a draft. It will be finalized after legal review before launch.');

  String get legalTermsBody => _t({
    'ko': '''제1조 (목적)
이 약관은 다리(이하 "회사")가 제공하는 외국인 구인정보 서비스(이하 "서비스")의 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항을 정함을 목적으로 합니다.

제2조 (회원가입)
회원가입은 구글, 애플, 페이스북 등 소셜 로그인을 통해 이루어지며, 회사가 정한 추가정보 입력을 완료해야 가입이 완료됩니다.

제3조 (서비스의 제공)
회사는 회원에게 구인정보 열람, 즐겨찾기, 지원 자동입력 등의 서비스를 제공합니다.

제4조 (회원의 의무)
회원은 정확한 정보를 제공하여야 하며, 허위 정보 제공으로 발생하는 불이익에 대해 회사는 책임지지 않습니다.

제5조 (서비스 이용의 제한)
회사는 회원이 서비스를 부정하게 이용하는 경우 사전 통지 없이 서비스 이용을 제한할 수 있습니다.

제6조 (회원탈퇴)
회원은 마이페이지에서 언제든지 회원탈퇴를 할 수 있으며, 탈퇴 시 개인정보는 관련 법령에 따라 처리됩니다.''',
    'en': '''Article 1 (Purpose)
These terms govern the rights, obligations, and responsibilities between Dari ("Company") and members regarding use of the foreign job information service ("Service").

Article 2 (Membership)
Membership is created via social login (Google, Apple, Facebook). Sign-up is complete only after the additional information required by the Company is submitted.

Article 3 (Provision of Service)
The Company provides job listing browsing, favorites, and application autofill features to members.

Article 4 (Member Obligations)
Members must provide accurate information. The Company is not responsible for disadvantages arising from false information.

Article 5 (Restriction of Service)
The Company may restrict service use without prior notice if a member misuses the Service.

Article 6 (Withdrawal)
Members may withdraw at any time from My Page. Upon withdrawal, personal data is handled in accordance with applicable law.''',
  }, '');

  String get legalPrivacyBody => _t({
    'ko': '''1. 수집 항목
이름, 생년월일, 성별, 국적, 비자타입, 전화번호, 이메일

2. 수집 목적
구인사이트 지원 시 자동입력 지원, 회원 식별 및 서비스 제공

3. 보유 및 이용 기간
회원탈퇴 시까지(탈퇴 후 관련 법령에 따른 기간 보관 후 파기)

4. 동의 거부 권리 및 불이익
위 개인정보 수집·이용에 동의하지 않을 권리가 있으며, 동의하지 않을 경우 지원 자동입력 등 일부 서비스 이용이 제한될 수 있습니다.''',
    'en': '''1. Items Collected
Name, date of birth, gender, nationality, visa type, phone number, email

2. Purpose of Collection
To support application autofill on job sites, identify members, and provide the Service

3. Retention Period
Until account withdrawal (retained afterward only as required by law, then destroyed)

4. Right to Refuse and Consequences
You may refuse to consent to this collection/use. Refusing may limit some features such as application autofill.''',
  }, '');

  String get legalThirdPartyBody => _t({
    'ko': '''1. 제공받는 자
K-HIRE 등 제휴 채용정보 사이트

2. 제공 목적
회원이 선택한 공고에 지원 시 필요한 정보 자동입력 지원

3. 제공 항목
이름, 생년월일, 성별, 국적, 비자타입, 전화번호

4. 보유 및 이용 기간
지원 처리 완료 시까지

5. 동의 거부 권리 및 불이익
위 제3자 제공에 동의하지 않을 권리가 있으며, 동의하지 않을 경우 자동입력 기능 없이 직접 지원해야 합니다.''',
    'en': '''1. Recipient
Partner job sites such as K-HIRE

2. Purpose
To support autofilling information needed when applying to a job you select

3. Items Provided
Name, date of birth, gender, nationality, visa type, phone number

4. Retention Period
Until the application is completed

5. Right to Refuse and Consequences
You may refuse to consent to this third-party sharing. Refusing means applying manually without autofill.''',
  ...
  }, 'You are currently logged in with the account above.\nLog out?');
  String get myPageWithdrawConfirmTitle =>
      _t({'ko': '회원탈퇴', 'en': 'Delete account'}, 'Delete account');
  String get myPageWithdrawConfirmDesc => _t(
    {
      'ko': '탈퇴하면 모든 정보가 삭제되며 복구할 수 없습니다.',
      'en':
  ...
  String get filterRegionHint => _t({
    ...
    'zh': '点击地区可选择区/郡',
    'hi': 'ज़िला चुनने के लिए क्षेत्र दबाएँ',
    'ja': '地域をタップすると市·郡·区まで選べます',
    'th': 'แตะภูมิภาคเพื่อเลือกเขต',
    'vi': 'Chạm vào khu vực để chọn quận/huyện',
    'bn': 'জেলা বাছতে অঞ্চলে চাপুন',
    'ru': 'Нажмите регион, чтобы выбрать районы',
    'id': 'Ketuk wilayah untuk pilih distrik',
    'ne': 'जिल्ला छान्न क्षेत्र थिच्नुहोस्',
    'km': 'ចុចតំបន់ដើម្បីជ្រើសស្រុក',
    'my': 'ခရိုင်ရွေးရန် ဒေသကိုနှိပ်ပါ',
    'si': 'දිස්ත්‍රික්ක තෝරන්න ප්‍රදේශය ඔබන්න',
    'uz': 'Tuman tanlash uchun hududni bosing',
    'mn': 'Дүүрэг сонгохоор бүс дээр дарна уу',
